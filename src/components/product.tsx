...
const Product = ({
  ...
  return (
    <div className="w-full relative border border-gray-300 flex flex-col items-center hover:bg-gray-100 h-full" onClick={() => router.push(href)} >
      {isPic ? (
        <>
      ...
      <div className="w-full relative p-5 flex flex-col gap-4">
        ...
        <div className="w-64 h-px bg-brand-100/50" />
